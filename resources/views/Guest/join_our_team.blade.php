          ...
          <div class="header_content__">
            ...
            <nav class="nav-om" id="navbar-menu-om">
              ...
              <ul class="nav-list-om list-unstyled">
                ...
                <li>
                  <a href="{{ url("") }}">خدماتنا</a>
                </li>
                <li>
                  <a href="our_team.html">فريقنا الطبى</a>
                </li>
                <li>
    ...
    <section class="page_head_wrapper">
      <figure class="figure__ asp-om loading-omd">
        <img
          ...
          data-src="{{ asset("guest/images/intro/10.jpg")}}"
          alt="..."
        />
      </figure>
      <div class="title_wrapper__">
        <div class="container">
          <h1 class="page_main_title__">إنضم إلينا</h1>
        </div>
      </div>
    </section>
    <!-- End Page Head Section -->

    <main class="join_our_team_section about_us_page default_page__">
      <div class="container">
        <div class="row row_modify with_row_gap">
          <div class="col-lg-6 col_center__">
            @include("success")
            @include("errors")
            <h3 class="block_title__">وظائف</h3>
            <p class="parag__">
              من فضلك قم بإدخال بياناتك الشخصية للحصول على وظيفة
            </p>

            <form action="{{ route("guestrequest/store") }}" method="POST" enctype="multipart/form-data">
                @csrf
              ...
              <div class="input_group__">
                <select class="select__ selectpicker" name="job_id"  >
              ...
              <div class="input_group__">
                <select class="select__ selectpicker" name="country_id">
              ...
              <div class="input_group__">
                <select class="select__ selectpicker" name="city_id">
              ...
              <div class="input_group__ upload_file_wrapper__">
                <label class="upload_file_label__ input__" for="personal_photo__">
                  <span class="label_placeholder__">إرفاق صورة شخصية </span>

                  <input type="file" name="image" id="personal_photo__" class="upload_input__">
                  <img class="icon__" src="{{ asset("guest/images/shapes/uplaod_input_icon__.svg")}}" alt="...">

                </label>
              </div>

              <div class="input_group__ upload_file_wrapper__">
                <label class="upload_file_label__ input__" for="cv_photo__">
                  <span class="label_placeholder__">إرفاق صورة CV </span>

                  <input type="file" name="file" id="cv_photo__" class="upload_input__">
                  <img class="icon__" src="{{ asset("guest/images/shapes/uplaod_input_icon__.svg")}}" alt="...">

                </label>
              </div>

              <button class="submit-button__ centered__">أرسال</button>
          ...
          <div class="col-lg-6 col_center__">
            <figure class="figure__ loading-omd asp-om">
              <img class="img-om lazy-omd" data-src="{{ asset("guest/images/join_our_team/01.png")}}" alt="...">
            </figure>
          </div>
        </div>
      </div>
