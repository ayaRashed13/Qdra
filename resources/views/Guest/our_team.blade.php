...
<html lang="ar" dir="rtl">
  ...
  <body>
    ...
    <section class="page_head_wrapper">
      <figure class="figure__ asp-om loading-omd">
        <img
          ...
          data-src="{{ asset("guest/images/intro/07.jpg")}}"
          alt="..."
        />
      </figure>
      <div class="title_wrapper__">
        <div class="container">
          <h1 class="page_main_title__">فريقنا الطبي</h1>
        </div>
      </div>
    </section>
    ...
    <main
      class="medical_rehabilitation_page__ default_section__ none_padding_top__ default_page__"
    >
      <div class="container">
